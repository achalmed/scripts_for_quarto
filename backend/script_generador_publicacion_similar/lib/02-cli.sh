...
Ejemplos:
  ...
  $GENIDX_SCRIPT_NAME ~/Documents/04\ index/_pubs/pub_actus-mercator \\
      --base-url https://actus-mercator.netlify.app

  # Sección de la página web (usa la URL base por defecto)
  $GENIDX_SCRIPT_NAME ~/Documents/04\ index/teching

  # Simular sin modificar nada
  $GENIDX_SCRIPT_NAME ~/Documents/04\ index/_pubs/pub_axiomata --dry-run
EOF
}
